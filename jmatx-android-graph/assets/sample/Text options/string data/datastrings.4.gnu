...
set bmargin  3
plot 'table.dat' using ($0-0.2):2 title 2 with boxes,      ''          using ($0+0.2):3 title 3 with boxes,      ''          using ($0):4     title 4 with linespoints,      ''          using ($0):5:xtic(1) title 5 with linespoints

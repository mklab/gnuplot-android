...
set x2tics border in scale 0,0 nomirror norotate  offset character 0, 0, 0 
set x2tics   ("mai" 0.00000, "jun" 1.00000, "jul" 2.00000, "aug" 3.00000, "sep" 4.00000, "okt" 5.00000, "nov" 6.00000, "des" 7.00000, "jan" 8.00000, "feb" 9.00000, "mar" 10.0000, "apr" 11.0000)
...
set bmargin  3
plot 'ctg-y2.dat' using ($0-0.2):2 index 0 with boxes title "precipitation 1992-2000",      ''           using ($0+0.2):2 index 1 with boxes title "              2000-2001",      ''           using ($0):2 index 2 with linespoints lw 3 title "runoff 1992-2000",      ''           using ($0):2:x2ticlabels(1) index 3 with linespoints lw 3 title "       2000-2001"

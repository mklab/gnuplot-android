...
set lmargin  9
set rmargin  2
plot 'finance.dat' using 0:2:3:4:5 notitle with financebars lt 8, 'finance.dat' using 0:9 notitle with lines lt 3, 'finance.dat' using 0:10 notitle with lines lt 1, 'finance.dat' using 0:11 notitle with lines lt 2

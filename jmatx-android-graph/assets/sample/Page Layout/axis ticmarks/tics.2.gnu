...
# set output 'tics.2.png'
set mxtics
set xtics border out scale 3,2 mirror rotate by 45  offset character 0, -1, 0 autofreq 
set ytics border in scale 3,2 mirror rotate by 45  offset character 0, 0, 0 autofreq 

...
# set output 'prob2.10.png'
set format x "%.1f"
set format y "%.2f"
set key inside right top vertical Right noreverse enhanced autotitles box linetype -1 linewidth 1.000
set label 1 "mu" at 1.5, 0.033253, 0 left norotate back nopoint offset character 0, 0, 0
set label 2 "sigma" at 3, 0.161314, 0 left norotate back nopoint offset character 0, 0, 0
set arrow 1 from 1, 0, 0 to 1, 0.265962, 0 nohead back nofilled linetype -1 linewidth 1.000
set arrow 2 from 1, 0.161314, 0 to 2.5, 0.161314, 0 nohead back nofilled linetype -1 linewidth 1.000
set samples 200, 200
set ytics border in scale 1,0.5 mirror norotate  offset character 0, 0, 0 0.00000,0.033253,0.332530
